...
@section('subhead')
    <title>Edit Aduan DPRD - KABUPATEN/KOTA</title>
@endsection
...
<br>
    <h1>Aproval Aduan DPRD - PROVINSI</h1>
    
    <form action="{{ route('updatequeuedprdkabupaten', $aduan->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <br>
    ...
    <input type="text" name="status" class="form-control" value="{{ $aduan->status }}" readonly>
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama" value="{{ $aduan->nama}}" class="form-control">
        </div>
        <div class="form-group">
            <label for="nama">Nama Partai:</label>
            <input type="text" name="nama_partai" value="{{ $aduan->nama_partai}}" class="form-control">
        </div>
        <div class="form-group">
            <label for="dapil">Dapil:</label>
            <input type="text" name="dapil" value="{{ $aduan->dapil}}" class="form-control">
        </div>
        <div class="form-group">
