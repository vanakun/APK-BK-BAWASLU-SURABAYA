            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                        @foreach($aduandprdkabupatenqueue as $aduan)
                <tr class="intro-x image-fit zoom-in">
                <td>
                        <a href="{{ route('insertqueuedprdkabupaten', ['id' => $aduan->id]) }}">
                    ...
                    <td>
                        <a href="{{ route('insertqueuedprdkabupaten', ['id' => $aduan->id]) }}">
                            <div class="font-medium whitespace-nowrap">{{ $aduan->dapil }}</div>
                        </a>
                    </td>
                    <td>
                        <a href="{{ route('insertqueuedprdkabupaten', ['id' => $aduan->id]) }}">
                ...
                @endforeach
                    ...
                    <div class="intro-y flex flex-col mt-4">
                        {!! $aduandprdkabupatenqueue->links('pagination') !!}
                    </div>
                </div>
                ...
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                            @foreach($aduandprdkabupatenproces as $aduan)
                            <tr class="intro-x image-fit zoom-in">
                            <td>
                                <a href="{{ route('editaduandprdkabupaten', ['id' => $aduan->id]) }}">
                                <div class="font-medium whitespace-nowrap">{{ $loop->iteration }}</div>
                                </a>
                            </td>
                            <td>
                    ...
                    <div class="intro-y flex flex-col mt-4">
                        {!! $aduandprdkabupatenproces->links('pagination') !!}
                    </div>
                </div>
                <!-- END: Data List -->
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                            @foreach($aduandprdkabupatendone as $aduan)
                            <tr class="intro-x image-fit zoom-in">
                    <td>
                        <a href="{{ route('editaduandprdkabupaten', ['id' => $aduan->id]) }}">
                        <div class="font-medium whitespace-nowrap">{{ $loop->iteration }}</div>
                    ...
                    <div class="intro-y flex flex-col mt-4">
                        {!! $aduandprdkabupatendone->links('pagination') !!}
                    </div>
                </div>
            </div>
        </div>
