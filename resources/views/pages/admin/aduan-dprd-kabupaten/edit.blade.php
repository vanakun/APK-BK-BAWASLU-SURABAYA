...
@section('subhead')
    <title>Edit Aduan DPRD - PROVINSI</title>
@endsection
...
<br>
    <h1>Edit Aduan DPRD - KABUPATEN</h1>
    
    <form action="{{ route('updateAduandprdkabupaten', $aduan->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <br>
