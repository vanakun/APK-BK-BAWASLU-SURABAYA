            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                        @foreach($aduandprqueue as $aduan)
                <tr class="intro-x image-fit zoom-in">
                    <td>
                        <a href="{{ route('insertqueuedpr', ['id' => $aduan->id]) }}">
                ...
                @endforeach
                    ...
                    <div class="intro-y flex flex-col mt-4">
                        {!! $aduandprqueue->links('pagination') !!}
                    </div>
                </div>
                ...
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                            @foreach($aduandprproces as $aduan)
                            <tr class="intro-x image-fit zoom-in">
                            <td>
                        <a href="{{ route('editaduandpr', ['id' => $aduan->id]) }}">
                        <div class="font-medium whitespace-nowrap">{{ $loop->iteration }}</div>
                        </a>
                    </td>
                    <td>
                    ...
                    <div class="intro-y flex flex-col mt-4">
                        {!! $aduandprproces->links('pagination') !!}
                    </div>
                </div>
                <!-- END: Data List -->
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
