            ...
            <div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                        @foreach($aduanPresidenWakilqueue as $aduan)
                <tr class="intro-x image-fit zoom-in">
                    <td>
                        <a href="{{ route('insertqueuePresidenWakil', ['id' => $aduan->id]) }}">
                ...
                @endforeach
                    ...
                    <div class="intro-y flex flex-col mt-4">
                        {!! $aduanPresidenWakilqueue->links('pagination') !!}
                    </div>
                </div>
                ...
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                            @foreach($aduanPresidenWakilproces as $aduan)
                            <tr class="intro-x image-fit zoom-in">
                    <td>
                        <a href="{{ route('editaduanpresidenwakil', ['id' => $aduan->id]) }}">
                            <div class="font-medium whitespace-nowrap">{{ $loop->iteration }}</div>
                        </a>
                    </td>
                    <td>
                    ...
                    <div class="intro-y flex flex-col mt-4">
                        {!! $aduanPresidenWakilproces->links('pagination') !!}
                    </div>
                </div>
                <!-- END: Data List -->
                <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                    ...
                    <table class="table table-report -mt-2">
                        ...
                        <tbody>
                            @foreach($aduanPresidenWakildone as $aduan)
                            <tr class="intro-x image-fit zoom-in">
                    <td>
                        <a href="{{ route('editaduanpresidenwakil', ['id' => $aduan->id]) }}">
                            <div class="font-medium whitespace-nowrap">{{ $loop->iteration }}</div>
                    ...
                    <div class="intro-y flex flex-col mt-4">
                        {!! $aduanPresidenWakildone->links('pagination') !!}
                    </div>
                </div>
            </div>
        </div>
