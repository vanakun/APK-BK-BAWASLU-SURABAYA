...
<br>
    <h1>Aproval Aduan DPD</h1>
    
    <form action="{{ route('updatequeuedpd', $aduan->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        <br>
    ...
    <input type="text" name="status" class="form-control" value="{{ $aduan->status }}" readonly>
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama_calon_dpd" value="{{ $aduan->nama_calon_dpd }}" class="form-control">
        </div>
        <div class="form-group">
