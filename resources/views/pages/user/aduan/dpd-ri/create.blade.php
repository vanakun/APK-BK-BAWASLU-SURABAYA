...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
            <br>
                <div class="card-header">Tambah Aduan Calon DPD RI</div>
                <br>
                <div class="card-body">
                    <form id="aduan_form" action="{{ route('aduan_dpd_ri.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            <label for="nama_calon_dpd">Nama Calon DPD RI:</label>
                            <select name="nama_calon_dpd" id="nama_calon_dpd" class="form-control">
                                @foreach ($presiden as $calon)
                                    <option value="{{ $calon->nama_calon_dpd }}">{{ $calon->nama_calon_dpd }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group mb-3">
