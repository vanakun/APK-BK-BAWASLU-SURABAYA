...
<br>
    ...
    <input type="text" name="status" class="form-control" value="{{ $aduan->status }}" readonly>
        ...
        <div class="form-group">
            ...
            <input type="text" name="jenis_atribut" value="{{ $aduan->jenis_atribut }}" class="form-control"readonly>
        </div>
        <div class="form-group">
            <label for="nama">Nama Calon:</label>
            <input type="text" name="nama" value="{{ $aduan->nama}}" class="form-control"readonly>
        </div>
        <div class="form-group">
            <label for="nama_partai">Nama Partai:</label>
            <input type="text" name="nama_partai" value="{{ $aduan->nama_partai}}" class="form-control"readonly>
        </div>
        <div class="form-group mb-3">
            <label for="dapil">Dapil:</label>
            <input type="text" name="dapil" value="{{ $aduan->dapil}}" class="form-control"readonly>
         </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="lokasi_pemasangan">Lokasi Pemasangan:</label>
            <input type="text" name="lokasi_pemasangan" value="{{ $aduan->lokasi_pemasangan }}" class="form-control"readonly>
        </div>
        <div class="form-group">
            <label for="nama_jalan">Nama Jalan:</label>
            <input type="text" name="nama_jalan" value="{{ $aduan->nama_jalan }}" class="form-control"readonly>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="date" name="tanggal_penertiban" value="{{ $aduan->tanggal_penertiban }}" class="form-control"readonly>
        </div>
        <div class="form-group">
            <label for="jenis_penertiban">Jenis Penertiban:</label>
            <select name="jenis_penertiban" class="form-control"readonly>
    ...
    <div class="image-preview"readonly>
    <br>
