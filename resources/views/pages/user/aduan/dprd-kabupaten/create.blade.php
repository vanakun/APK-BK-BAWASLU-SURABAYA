            ...
            <div class="container mt-4">
                <div class="row">
                    <div class="col-md-8 offset-md-2">
                        <div class="card">
                            <br>
                            <div class="card-header">Tambah Aduan Calon DPRD KABUPATEN/KOTA</div>
                            <br>
                            <div class="card-body">
                                <form id="aduan_form" action="{{ route('aduan_dprd_kabupaten.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <option value="">-- Pilih Calon --</option>
                                            @foreach ($presiden as $calon)
                                                <option value="{{ $calon->nama_calon_dprd_kota }}" data-partai="{{ $calon->partai->nama_partai }}">{{ $calon->nama_calon_dprd_kota }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group mb-3">
