...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
            <br>
                <div class="card-header">Tambah Aduan Presiden dan Wakil Presiden</div>
                <br>
                <div class="card-body">
                    <form id="aduan_form" action="{{ route('aduan_presiden_wakil_presiden.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="nama_calon" id="nama_calon" class="form-control">
                                @foreach ($presiden as $calon)
                                    <option value="{{ $calon->nama_presiden }} & {{ $calon->nama_wakil }}">{{ $calon->nama_presiden }} - {{ $calon->nama_wakil }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group mb-3">
